...
effect-measure-compatible sector probabilities; full
\texttt{EffectMeasure} instantiation on matrix effects awaits nems-lean
diagonal-effect constructors (Rank 070-97B2 open).
