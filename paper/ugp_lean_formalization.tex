...
\begin{table}[ht]
\centering
\caption{Open conjectures formally stated in ugp-lean.}
...
Mirror Min-Dual       & \lstinline|MirrorMinDualConjecture|        & Open \\
Fibonacci Rigidity    & \lstinline|FibRigidityConjecture|          & Open \\
Robust Universality   & \lstinline|RobustUniversalityConjecture|   & Open \\
Sharp Boundary        & \lstinline|SharpDecidabilityBoundaryConj.| & Open \\
MDL Selection         & \lstinline|MDLSelectionConjecture|         & Open \\
Kernel Compatibility  & \lstinline|KernelCompatibilityConjecture|  & Open \\
Global $c$-Attractor  & \lstinline|GlobalCAttractorConjecture|     & Open \\
