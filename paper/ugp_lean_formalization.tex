...
All open conjectures are formally stated as \lean{} definitions
of type \texttt{Prop} in \texttt{UgpLean.\allowbreak Conjectures}
and \texttt{UgpLean.\allowbreak GTE.\allowbreak UGPPrimes}.
\Cref{tab:conjectures} lists them.

\begin{table}[ht]
\centering
\caption{Conjectures from the UGP paper.  Seven of ten are now
  \textbf{proved} in ugp-lean; three remain open.}
\label{tab:conjectures}
\begin{tabular}{@{}lll@{}}
\toprule
\textbf{Conjecture} & \textbf{Lean name} & \textbf{Status} \\
\midrule
Mirror Min-Dual       & \lstinline|mirror_min_dual_proved|         & \textbf{Proved} \\
Fibonacci Rigidity    & \lstinline|fib_rigidity_proved|            & \textbf{Proved} \\
MDL Monotonicity      & \lstinline|c1_monotone_in_q2|             & \textbf{Proved} \\
Robust Universality   & \lstinline|robust_universality_proved|     & \textbf{Proved} \\
Sharp Boundary        & \lstinline|sharp_boundary_proved|          & \textbf{Proved} \\
Kernel Compatibility  & \lstinline|kernel_compatibility_proved|    & \textbf{Proved} \\
Global $c$-Attractor  & \lstinline|global_c_attractor_proved|      & \textbf{Proved} \\
\midrule
