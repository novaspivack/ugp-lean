...
\medskip\noindent\textbf{Documented axioms (97 global named axioms).}
...
The library currently holds \textbf{97} global custom named axioms,
primarily in \texttt{GUTStructure}, \texttt{FrobeniusChain},
\texttt{NeutrinoSector}, \texttt{SechOverlapIntegralBounds\_bridge}, and related
...
(\lstinline|rule110_turing_universal_from_cook|, zero \texttt{sorry} modulo five
...
(Cook's operational universality theorem \lstinline|rule110_turing_universal_from_cook|
...
operational universality theorem \lstinline|rule110_turing_universal_from_cook|
...
The verified global named-axiom total is \textbf{97}.
...
\hline
\texttt{Substrate.SechOverlap\allowbreak IntegralBounds\_bridge} & Mesh-to-integral bridge for $r\in\{5,11\}$ & 2 \\
\texttt{Universality.GUTStructure}    & Native\_decide certs and SM structure & 43 \\
\texttt{Universality.FrobeniusChain}  & FGCI uniqueness and chain closure & 4 \\
\texttt{MassRelations.NeutrinoSector} & PMNS angles, CP phase, seesaw & 5 \\
\texttt{Gravity.YukawaOverlapExponent} & DPP tape-counting, Yukawa scaling & 4 \\
Other modules                         & Bridge and auxiliary axioms & 39 \\
\hline
\textbf{Global named custom axioms}   & \textbf{total} & \textbf{97} \\
\bottomrule
\end{tabular}
\caption{Custom named-axiom inventory. Each row lists the module, physical scope,
  and axiom count. The global verified total is \textbf{97}; the core physics
  ...
  ``Other modules'' includes the two Turing-universality bridge axioms below.}
...
\item \textbf{Added, justified:} \lstinline|cook_rule110_simulates_computable|
  ...
  operational universality theorem (\lstinline|rule110_turing_universal_from_cook| in
  \texttt{rule110-lean}) composed with universal Turing-machine/partial-recursive
...
the verified global named-axiom total is 97 (see Table~\ref{tab:axiom-inventory}).
