...
\texttt{Phase4}, \texttt{GaloisStructure}, \texttt{CyclotomicCompleteness},
and \texttt{TE22}, for example:
...
The modules \texttt{Papers} and \texttt{Instance} supply chiefly \emph{citable stubs}
and bridge entry points; \texttt{Conjectures} records resolved and open claims; and
\texttt{Phase4} also contains stubs alongside the result modules named above.
