...
levels, and a precise statement of the mirror-dual conjecture with a
proof that the divisor count $\tau(2^n-16)$ is unbounded.  All
definitions are self-contained; all open conjectures are formally stated
...
\item \textbf{Mirror-dual conjecture} (\S\ref{sec:mirror}): A precise
  formal statement with five machine-verified witness pairs and a proof
  that the divisor count $\tau(2^n - 16)$ is unbounded.
\end{itemize}
...
\begin{itemize}[nosep]
\item \textbf{Mathlib} v4.29.0-rc3~\cite{mathlib4}: number theory
...
This theorem ensures that the ``raw material'' for mirror-dual
...
(\cref{thm:tau-unbounded}), and the precise formal statement of the
mirror-dual conjecture (\cref{conj:mirror}) with five machine-verified
witness pairs.
...
\lean{} v4.29.0-rc3 and Mathlib v4.29.0-rc3.  The command
