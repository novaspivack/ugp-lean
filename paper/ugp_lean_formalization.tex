...
framework in \lean{}~4 against Mathlib, comprising 103 modules with a
...
The artifact is organized into 103~\lean{} modules across eleven layers:
...
(\texttt{native\_decide} on \texttt{ridgeSurvivorsFinset~n}), and
(ii) an analytic bound for $n \ge 13$: AM-GM over $\mathbb{Z}$ yields
$b_2 + q_2 \ge 180$ from $b_2 q_2 \ge 8176$ and $b_2, q_2 \ge 16$,
so $b_1 = b_2+q_2+7 \ge 187 \ne 73$.
