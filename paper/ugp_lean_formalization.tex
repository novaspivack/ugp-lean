...
For $\omega \neq 0$, the Klein--Gordon mode $\phi''+\omega^2\phi=0$ factors into chiral Schr\"odinger modes $(i\partial_t \pm \omega)\phi_\pm=0$ with $\phi=\phi_++\phi_-$ ($\CatAD$; chiral decomposition proof in progress in \texttt{ugp-lean-exp}).
\end{theorem}
