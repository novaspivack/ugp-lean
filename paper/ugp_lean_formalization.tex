...
The EPIC\_083C pass adds \textbf{203} net-new zero-\texttt{sorry} theorems across
...
$N_c=3$, and Pöschl--Teller fluctuation/QFT integral infrastructure.
...
\midrule
\multicolumn{3}{@{}l}{\textit{$\mathbb{Z}_7$ dark-baryon correction (\CatAL)}} \\[2pt]
...
identities.  The development catalog lists 203 net-new names.}
\label{tab:epic-083c}
\end{table}
