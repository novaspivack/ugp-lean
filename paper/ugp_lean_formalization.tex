...
224~\lean{} modules across seventeen layers (extended development branch covering
...
The artifact is organized into 224~\lean{} modules across seventeen layers
...
\node[layer, fill=purple!8, below=of ipt]   (univ)
  {\textbf{Universality}~(62)\quad Rule110, UWCA, UWCASimulation,
   ...
   \textbf{Z3SubOrbitDisjointness}, \textbf{PSCOrbitWindows}};
