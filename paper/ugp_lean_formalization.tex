...
\texttt{d\_\allowbreak top\_\allowbreak derivation\_\allowbreak chain\_\allowbreak catal}
  & Universality.GUTStructure
  & $D_{\rm top}=\exp(-1/N_c)$ from BPS $S_0/T=1$, $q_{\rm dark}=2$, $|\mathbb{Z}_7^*|=6$, transitivity \\
\bottomrule
\end{tabular}
...
integrals, Yukawa vertex (\CatAD), FGCI at $N_c=3$, and $\mathbb{Z}_7$ dark-baryon
identities including $D_{\rm top}=\exp(-1/N_c)$ (\CatAL, Lean-certified).
The library contains 221 net-new names in this section.}
