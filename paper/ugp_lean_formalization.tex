...
framework in \lean{}~4 against Mathlib, comprising 114 modules with a
...
The artifact is organized into 114~\lean{} modules across twelve layers
...
\noindent\textit{Migration note: \texttt{CyclotomicCompleteness.H9SelfConsistency} and
\texttt{CyclotomicCompleteness.GoldenRatioFixedPoint} have been moved to
