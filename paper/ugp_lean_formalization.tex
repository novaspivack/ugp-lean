...
\paragraph{Full composite c-rule conjunction.}
The theorem \lstinline|ugp_composite_braid_c_rule| (zero sorry) bundles all
five structural facts: meson winding zero, $c$ real-positive, and all three
Mersenne tier boundaries as arithmetic consequences of $N_c = 3$.
Status: \textbf{Category~A} for the winding and chirality theorems;
\textbf{Category~A/D} for the sector assignment of specific hadrons
(empirically validated by the $r = -0.981$ correlation in Ref.~\cite{Spivack2026_Closure24};
axiomatic derivation of the sector assignment rule is future work).
