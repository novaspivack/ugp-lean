...
308~\lean{} modules across seventeen layers (canonical library covering
spacetime, QFT, and hadronic physics) with a strict zero-sorry,
zero-custom-axiom policy on the core proof path (97 global custom
named axioms across all modules; core physics proof path remains
zero-axiom).
...
The artifact is organized into 308~\lean{} modules across seventeen layers
