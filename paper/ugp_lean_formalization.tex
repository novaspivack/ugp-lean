...
\item \lstinline|phimdl_no_susy_degenerate_spectrum| (\texttt{CCImpossibilityBundle}) — type \lstinline|: True|; trivially proved.
\item \lstinline|phimdl_no_antigravitating_sector| (\texttt{CCImpossibilityBundle}) — type \lstinline|: True|; trivially proved.
