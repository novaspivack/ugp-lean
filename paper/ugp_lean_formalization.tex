...
framework in \lean{}~4 against Mathlib, comprising 110 modules with a
...
The artifact is organized into 110~\lean{} modules across twelve layers:
...
\node[layer, fill=teal!8,   below=of struc] (mass)
  {\textbf{MassRelations}~(18)\quad KoideClosedForm, KoideNewtonFlow,
   ...
   NeutrinoFroggattNielsen}};
\node[layer, fill=cyan!6,   below=of mass]  (braid)
  {\textbf{BraidAtlas}~(5)\quad ChargeTheorem, CompositeTriples, ChiralitySquaring, ChargeDerivation;
   \textbf{PSC}~(1)\quad \textbf{RCCInfiniteFamilies}};
...
The new module \texttt{BraidAtlas.ChargeDerivation} (108th module, EPIC~23 SP-2)
...
The new module \texttt{PSC.RCCInfiniteFamilies} (109th module, EPIC~23 SP-1 extension)
...
\texttt{TE22.ScanCertificate} module (computational, EPIC~23 SP-1):
...
% ═══════════════════════════════════════════════════════════════
\section{Neutrino FN Texture Selection (\texttt{MassRelations.NeutrinoFroggattNielsen})}
\label{sec:neutrino_fn}
% ═══════════════════════════════════════════════════════════════

The new module \texttt{MassRelations.NeutrinoFroggattNielsen} (110th module)
...
(companion physics paper~\cite{SpivackNeutrino}).
