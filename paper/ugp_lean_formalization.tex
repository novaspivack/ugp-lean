...
440~\lean{} modules across multiple organizational layers (canonical library covering
...
The artifact is organized into 440~\lean{} modules across multiple organizational layers
...
\node[layer, fill=olive!8,  below=of fwk]   (space)
  {\textbf{Spacetime}~(33)\quad CausalGraph, CausalInvariance, LiftingTheorem,
   ...
   \textit{new:} \textbf{PhiMDLZeroModeIndex}
