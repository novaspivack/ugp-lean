...
% ═══════════════════════════════════════════════════════════════
\subsection{Coxeter--Conductor Theorem (\texttt{BraidAtlas.\allowbreak CoxeterConductor},
            \texttt{BraidAtlas.\allowbreak CoxeterConductorTowerLaw})}
...
% ═══════════════════════════════════════════════════════════════
\section{Galois-Protection Non-Renormalization (\texttt{Phase4.\allowbreak GaloisProtection})}
...
\subsection{Koide \texorpdfstring{$S_3$}{S3} Discrete Arithmetic-Mean Identity (\texttt{MassRelations.\allowbreak KoideS3DiscreteIdentities})}
