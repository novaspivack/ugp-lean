...
392~\lean{} modules across multiple organizational layers (canonical library covering
spacetime, QFT, and hadronic physics) with a strict zero-sorry,
zero-custom-axiom policy on the core proof path (core physics proof path remains
zero-axiom).
...
The artifact is organized into 392~\lean{} modules across multiple organizational layers
