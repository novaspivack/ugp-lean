...
442~\lean{} modules across multiple organizational layers (canonical library covering
...
The artifact is organized into 442~\lean{} modules across multiple organizational layers
...
\texttt{scripts/gen\_ucl\_mass\_ordering\_certs.py}
  & \texttt{UCLMassOrderingSBounds.lean},\newline\texttt{UCLMassOrderingCerts.lean},\newline\texttt{UCLMassOrderingBridge.lean}
...
\texttt{scripts/gen\_sech5\_mesh\_proof.py}
  & \texttt{SechOverlapIntegralBounds\_r5mesh.lean} (partial)
  & $r{=}5$ half-line mesh with per-point Taylor cosh proofs; \texttt{norm\_num}
  & \texttt{python3 scripts/gen\_sech5\_mesh\_proof.py} \\[4pt]
\texttt{scripts/gen\_sech5\_cosh\_bins.py}
  & \texttt{SechOverlapIntegralBounds\_r5bins.lean}
  & 990 per-bin cosh bound lemmas for $r{=}5$; zero sorry
  & \texttt{python3 scripts/gen\_sech5\_cosh\_bins.py} \\[4pt]
...
\item \texttt{SechOverlapIntegralBounds\_cosh.lean} ---
