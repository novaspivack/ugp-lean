...
% ═══════════════════════════════════════════════════════════════
\subsection{New algebraic certificates (second wave)}\label{subsec:epic-088}
% ═══════════════════════════════════════════════════════════════
...
% TODO (next formalization-paper update pass): insert documentation for
% remaining retrospective targets when certified — particularly the
% Φ₆ stability / BPS kink ground-state corrections and any biquadratic
% or AGL extensions. Add a new \paragraph after the
% "Retrospective closures" paragraph above, following the same pattern.
