...
The artifact is organized into 221~\lean{} modules across seventeen layers
...
\node[layer, fill=purple!8, below=of ipt]   (univ)
  {\textbf{Universality}~(60)\quad Rule110, UWCA, UWCASimulation,
   ...
   SylowIndexCouplingHierarchy, DynamicalCouplingBridge, LorentzInvariance,
   ...
   BeableWindingPartitionInstance, TwoRoleTheorem (\textrm{+1 more})};
...
\node[layer, fill=olive!8,  below=of fwk]   (space)
  {\textbf{Spacetime}~(31)\quad CausalGraph, CausalInvariance, LiftingTheorem,
