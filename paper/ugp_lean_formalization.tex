...
361~\lean{} modules across multiple organizational layers (canonical library covering
...
The artifact is organized into 368~\lean{} modules across multiple organizational layers
...
\node[layer, fill=teal!8,   below=of struc] (mass)
  {\textbf{MassRelations}~(39)\quad KoideClosedForm, KoideNewtonFlow,
...
\node[layer, fill=olive!8,  below=of fwk]   (space)
  {\textbf{Spacetime}~(32)\quad CausalGraph, CausalInvariance, LiftingTheorem,
   ...
   (+ 3 Spectral sub-modules; canonical library, zero sorry unless noted)};
