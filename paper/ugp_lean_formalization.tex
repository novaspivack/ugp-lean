...
A \textbf{MassRelations} layer (20 modules) formalizes the
...
\node[layer, fill=teal!8,   below=of struc] (mass)
  {\textbf{MassRelations}~(20)\quad KoideClosedForm, KoideNewtonFlow,
   ...
   \textbf{CKMTheta23, KoideS3DiscreteIdentities}};
\node[layer, fill=cyan!6,   below=of mass]  (braid)
  {\textbf{BraidAtlas}~(7)\quad ChargeTheorem, CompositeTriples, ChiralitySquaring, ChargeDerivation,
   ...
   \textbf{PSC}~(2)\quad RCCInfiniteFamilies, \textbf{ThreeRouteForcing}};
...
The \texttt{MassRelations} layer (20 modules) formalizes the
...
(\cref{sec:massrelations}, 20 modules):
