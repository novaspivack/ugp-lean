...
\midrule
\addlinespace[2pt]
\multicolumn{4}{@{}l}{\textit{Intrinsic area-scaling cut measure (\S\ref{subsec:cut-area-scaling})}} \\
\addlinespace[2pt]
\lstinline|cutEdgeAt_injective|                & Spacetime.\allowbreak SpacelikeCutAreaScaling & --- & \textbf{Yes} \\
\lstinline|cutEdgeAt_is_spacelike_adj|          & Spacetime.\allowbreak SpacelikeCutAreaScaling & --- & \textbf{Yes} \\
\texttt{cutEdgeAt\_characterizes\_\allowbreak x\_crossing} & Spacetime.\allowbreak SpacelikeCutAreaScaling & --- & \textbf{Yes} \\
\lstinline|cut_crossing_finset_card_eq_L_sq|    & Spacetime.\allowbreak SpacelikeCutAreaScaling & --- & \textbf{Yes} \\
\texttt{three\_tape\_config\_card\_\allowbreak confirms\_reading\_A} & Spacetime.\allowbreak ThreeTapeCutAreaScaling & P45 & \textbf{Yes} \\
\texttt{spatialPoint\_eq\_\allowbreak causalNode\_spatial\_part} & Spacetime.\allowbreak ThreeTapeCutAreaScaling & P45 & \textbf{Yes} \\
\texttt{spatialAdj\_eq\_\allowbreak spacelikeAdj\_at\_shared\_time} & Spacetime.\allowbreak ThreeTapeCutAreaScaling & P45 & \textbf{Yes} \\
\lstinline|three_tape_cut_crossing_card_eq_L_sq| & Spacetime.\allowbreak ThreeTapeCutAreaScaling & P45 & \textbf{Yes} \\
\addlinespace[4pt]
\midrule
\addlinespace[2pt]
...
\lstinline|color_action_not_flavor_action| \ldots\ \lstinline|z3_disambig_master| (10 thms)
  & Algebra.\allowbreak OctonionColorFlavorDisambiguation & P55 & \textbf{Yes} \\
\lstinline|sigma_swaps_q4_q3| \ldots\ \lstinline|kink_sigma_parity_master| (11 thms)
  & Algebra.KinkSigmaParityAction & P55 & \textbf{Yes} \\
\texttt{s3\_acts\_faithfully\_\allowbreak on\_generation\_sectors} \ldots (12 thms)
...
\lstinline|sigma_maps_fermion_to_boson| \ldots\ \lstinline|braid_phase_z2_but_not_s3| (20 thms)
  & Algebra.\allowbreak BraidAtlasPhaseEquivariance & P55 & \textbf{Yes} \\
\lstinline|b_R1_eq_5| \ldots\ \lstinline|normal_ordering_from_seeds| (16 thms)
  & MassRelations.\allowbreak SeesawTrialityPinning & P55 & \textbf{Yes} \\
\addlinespace[4pt]
\midrule
\addlinespace[2pt]
