...
\midrule
\addlinespace[2pt]
\multicolumn{4}{@{}l}{\textit{Inert Primes \& $\rho_F$ Identity (\S\ref{sec:inertprimes})}} \\
\addlinespace[2pt]
\lstinline|qm_no_root_of_legendreSym_neg_one| & GTE.InertPrimes & Thm~\ref{thm:inert} & \textbf{General} \\
\lstinline|qm_no_root_mod_13..137|            & GTE.InertPrimes & Thm~\ref{thm:inert-15} & \textbf{Yes} \\
\lstinline|qm_inert_primes_certified|         & GTE.InertPrimes & Thm~\ref{thm:inert-15} & \textbf{Yes} \\
\lstinline|kappa_unram_lower_bound|           & GTE.InertPrimes & Thm~\ref{thm:kappa-pos} & \textbf{Yes} \\
\lstinline|kappa_unram_pos|                   & GTE.InertPrimes & Thm~\ref{thm:kappa-pos} & \textbf{Yes} \\
\lstinline|discKminus|, \lstinline|discKplus| & GTE.ResonantFactory & Thm~\ref{thm:disc} & \textbf{Yes} \\
\lstinline|rhoF_identity_verified|            & GTE.ResonantFactory & Thm~\ref{thm:rhoF-id} & \textbf{Yes} \\
\lstinline|doubly_inert_71|                   & GTE.ResonantFactory & Thm~\ref{thm:rhoF-id} & \textbf{Yes} \\
\lstinline|hasse_check_extended|              & GTE.ResonantFactory & Thm~\ref{thm:rhoF-id} & \textbf{Yes} \\
\addlinespace[4pt]
\midrule
\addlinespace[2pt]
\multicolumn{4}{@{}l}{\textit{Analytic Architecture (\S\ref{sec:analytic})}} \\
\addlinespace[2pt]
\lstinline|dickman_equidistribution_in_APs|  & GTE.AnalyticArch & Thm~\ref{thm:dickman} & Sorry (Tenenbaum) \\
\lstinline|crt_equidistribution_within_regime| & GTE.AnalyticArch & Thm~\ref{thm:crt-regime} & Sorry (Tenenbaum+CRT) \\
\lstinline|qminus_qplus_coprime|             & GTE.AnalyticArch & Thm~\ref{thm:qcoprime} & \textbf{Yes} \\
\lstinline|dickmanThreeHalves_pos|           & GTE.AnalyticArch & Thm~\ref{thm:dickman-pos} & \textbf{Yes} \\
\addlinespace[4pt]
\midrule
\addlinespace[2pt]
...
\midrule
\addlinespace[2pt]
\multicolumn{4}{@{}l}{\textit{Resolved Conjectures (\S\ref{sec:conjectures})}} \\
\addlinespace[2pt]
\lstinline|mirror_min_dual_proved|    & Conjectures             & Thm~\ref{thm:mirror-min}  & \textbf{Yes} \\
\lstinline|fib_rigidity_proved|       & Conjectures             & Thm~\ref{thm:fib-rigid}   & \textbf{Yes} \\
\lstinline|c1_monotone_in_q2|        & Conjectures             & Thm~\ref{thm:mdl-mono}    & \textbf{Yes} \\
\lstinline|robust_universality_proved|& Conjectures             & Thm~\ref{thm:robust-univ} & \textbf{Yes} \\
\lstinline|sharp_boundary_proved|     & Conjectures             & Thm~\ref{thm:sharp-bd}    & \textbf{Yes} \\
\lstinline|kernel_compatibility_proved|& Conjectures            & Thm~\ref{thm:kern-compat} & \textbf{Yes} \\
\lstinline|global_c_attractor_proved| & Conjectures             & Thm~\ref{thm:c-attract}   & \textbf{Yes} \\
\addlinespace[4pt]
\midrule
\addlinespace[2pt]
