...
\midrule
\addlinespace[2pt]
\multicolumn{4}{@{}l}{\textit{GTE-NEMS Framework Instance (\S\ref{subsec:gte-framework-instance})}} \\
\addlinespace[2pt]
\lstinline|GTEFramework|               & Framework.GTEFrameworkInstance & --- & \textbf{Yes} \\
\lstinline|gte_not_categorical|        & Framework.GTEFrameworkInstance & --- & \textbf{Yes} \\
\lstinline|gte_nems|                   & Framework.GTEFrameworkInstance & NEMS   & \textbf{Yes} \\
\lstinline|GTEPSCBundle|               & Framework.GTEFrameworkInstance & PSC    & \textbf{Yes} \\
\lstinline|GTEDiagonalCapable|         & Framework.GTEFrameworkInstance & ASR    & 1 axiom \\
