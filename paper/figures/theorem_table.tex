...
\lstinline|psc_entropy_contraction_duality_proved| & VEVProof.PSCEntropyDuality & P27 & \textbf{Yes} \\
\lstinline|per_gen_volume_correction|   & VEVProof.GoldstoneEntropy & P27    & \textbf{Yes} \\
\lstinline|ew_goldstone_count|, \lstinline|vol_S3_eq| & VEVProof.EWGoldstoneManifold & P27 & \textbf{Yes} \\
\lstinline|ew_vacuum_manifold_uniqueness| & VEVProof.EWGoldstoneManifold & P27 & \textbf{Yes} \\
\addlinespace[4pt]
\midrule
\addlinespace[2pt]
...
\lstinline|cup1_orbit_uniquely_selects_rule110| & Univ.CUP4TotalParity & CUP-4 & \textbf{Yes} \\
...
\lstinline|cup3d_psc_goe_chain|         & Univ.CUP3DPSCUnification & PSC     & \textbf{Yes} \\
\lstinline|physical_incompleteness_thm| & Univ.CUP3DPhysicalInc.  & CUP-PI  & 3 axioms \\
\lstinline|hypothesis_b_tape_level|     & Univ.HypothesisB        & Hyp B   & 1 axiom \\
\lstinline|hypothesis_c_psc_forces_universality| & Univ.PSCUniversality & Hyp C & 1 axiom \\
\lstinline|gte_compilation_theorem|     & Univ.GTECompilation     & \S\ref{subsec:gte-compilation} & \textbf{Yes} \\
\lstinline|gte_unique_bisimulation|     & Univ.GTEUniqueness      & \S\ref{subsec:gte-uniqueness} & \textbf{Yes} \\
\addlinespace[4pt]
\midrule
\addlinespace[2pt]
\multicolumn{4}{@{}l}{\textit{GoE Stability \& Orbit Perturbation (\S\ref{subsec:goe-stability}--\ref{subsec:orbit-perturbation})}} \\
\addlinespace[2pt]
\lstinline|gen1_is_goe|                 & Univ.GoEStabilityHierarchy & GoE  & \textbf{Yes} \\
\lstinline|gen2_unique_predecessor|     & Univ.GoEStabilityHierarchy & ---  & \textbf{Yes} \\
\lstinline|sm_chain_fully_isolated|     & Univ.GoEStabilityHierarchy & ---  & \textbf{Yes} \\
\lstinline|orbit_perturbation_destroys_universality| & Univ.OrbitPerturbCat. & P28 & \textbf{Yes} \\
\addlinespace[4pt]
\midrule
\addlinespace[2pt]
...
\lstinline|ca_w_plus_is_emission_not_absorption| & Univ.Z7ChargeConj. & P33 & \textbf{Yes} \\
...
\addlinespace[2pt]
\lstinline|z5_prime_unique_transitivity| & Univ.Z5TransitivityUniq. & P28 & \textbf{Yes} \\
\lstinline|three_dim_fmdl_structure_forced| & Univ.DimSliceUniq.   & P36  & \textbf{Yes} \\
\lstinline|gtp_neutral_particles_distinct| & Univ.GTPNeutralDisc.  & P28  & \textbf{Yes} \\
...
\addlinespace[2pt]
\lstinline|zone_L0_is_vacuum|           & Univ.LawvereZone        & P34  & \textbf{Yes} \\
\lstinline|zone_L1_is_goe_orbit|        & Univ.LawvereZone        & P34  & \textbf{Yes} \\
\lstinline|zone_L2_lawvere_diagonal|    & Univ.LawvereZone        & P34  & \textbf{Yes} \\
\addlinespace[4pt]
\midrule
\addlinespace[2pt]
...
\lstinline|charge_from_z7_winding|      & Univ.GUTStructure §49   & P37  & \textbf{Yes} \\
\lstinline|hypercharge_u_quark|, \lstinline|weinberg_angle_from_hypercharge_sum| & Univ.GUTStructure §73 & P37 & \textbf{Yes} \\
...
\addlinespace[2pt]
\lstinline|GTEFramework|               & Framework.GTEFrameworkInstance & NEMS   & \textbf{Yes} \\
\lstinline|gte_tpc_from_nems_classification| & Framework.GTEFrameworkInstance & C3 & \textbf{Yes} \\
\lstinline|gte_tpc_real|               & Framework.GTEFrameworkInstance & C3     & \textbf{Yes} \\
\lstinline|gte_d_unique|               & Framework.GTEOptimalityInstance & P34   & \textbf{Yes} \\
...
\midrule
\addlinespace[2pt]
\multicolumn{4}{@{}l}{\textit{Quantum Gravity Completion --- EPIC\_078 (2026-05-27/28)}} \\
\addlinespace[2pt]
\lstinline|minimal_coupling_is_mdl_minimal|          & Gravity.MinimalCoupling      & P36  & \textbf{Yes} \\
\lstinline|z7_superselection_preserved_by_flat_metric| & Gravity.MinimalCoupling    & P36  & \textbf{Yes} \\
...
\lstinline|gte_friedmann_correction_at_planck_zero|  & Gravity.BounceAndArithmetic  & P38  & \textbf{Yes} \\
...
\lstinline|mdl_initial_state_flat_spatial_sections|  & Gravity.WaldChainInitState   & P36  & \textbf{Yes} \\
...
\lstinline|gte_qgr_derivation_chain_catAL_summary|  & GTEDerivationChain           & P43  & \textbf{Yes} \\
\lstinline|cmca_tensor_product_gives_31d_minkowski|  & Gravity.DimDecomposition     & P41  & \textbf{Yes} \\
...
\lstinline|gte_triple_kink_exchange_statistics|      & Gravity.FermionicStatistics  & P43  & \textbf{Yes} \\
\lstinline|dimensional_protocol_principle_master|    & Gravity.RelationalTime       & P43  & \textbf{Yes} \\
...
\lstinline|gte_winding_identifies_charged_fermions|  & BraidAtlas.WindingToBraid    & P37  & \textbf{Yes} \\
\lstinline|qec_gte_is_stabilizer_code|               & Substrate.GEQECCode          & P34  & \textbf{Yes} \\
\lstinline|rule110_gf7_vacuum_fixed_point_master|    & ContinuumLimit.GF7Vacuum     & P36  & \textbf{Yes} \\
\addlinespace[4pt]
\midrule
\addlinespace[2pt]
\multicolumn{4}{@{}l}{\textit{Three-tape CMCA (2026-05-28)}} \\
\addlinespace[2pt]
...
\lstinline|gte_fermionic_sector_no_primitive_root|   & BraidAtlas.WindingToBraidRep & P45  & \textbf{Yes} \\
