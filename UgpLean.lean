...
- `UgpLean.ContinuumLimit.WassersteinDistance` — OQ-QG-1 Step 2: W₁ scaffold; `W1` = sInf coupling costs; `W1_le_couplingCost` + `W1_ge_of_lipschitz` (Kantorovich weak dual) CatAL; 4 general W1 property sorries; `gorard_vacuum_oric_zero` axiom + `gorard_vacuum_oric_zero_of_w1` CatAL (2026-05-31)
