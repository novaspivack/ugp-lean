...
- `UgpLean.ContinuumLimit.WassersteinDistance` — OQ-QG-1 Step 2: W₁ scaffold; `W1` = sInf coupling costs; `W1_le_couplingCost` CatAL; 4 general W1 property sorries; `gorard_vacuum_oric_zero` axiom + `gorard_vacuum_oric_zero_of_w1` CatAL (2026-05-31)
- `UgpLean.ContinuumLimit.GorardVacuumW1Bridge` — 083-ORIC-AXIOM-UPGRADE: vacuum graph/measures/coupling CatAL; `vacuum_w1_le_one` CatAL; `vacuum_w1_eq_one` sorry (CDF↔OT lower bound) (2026-05-31)
