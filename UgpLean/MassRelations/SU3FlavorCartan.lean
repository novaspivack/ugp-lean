...
**Round 13, Phase 1 — structural derivation of the TT formula's α coefficient.**

## Context

The TT up-to-lepton mass relation (COMP-P01-TT, Round 12):

    log(m_{u_g} / m_{lep_g}) = (π/6) · 2^g + β    for g = 1, 2, 3

fits at 0.2% precision with null density 6×10⁻⁶.  Round 13 aims to derive the
coefficient `α = π/6` from Lie-theoretic structure rather than leave it as an
observed correspondence.

## Claim A (revised, Round 13 Session 1)
...
Remaining structural gaps (Claims B and C in 13_SPEC) are the physics bridge:
...
- 13_SPEC_ALPHA_PI_6_DERIVATION.md
- 18_LAB_NOTES_ROUND13_ALPHA_PI_6_PHASE1.md
- COMP-P01-TT json artifact (SHA: d8227f9d...)
-/
