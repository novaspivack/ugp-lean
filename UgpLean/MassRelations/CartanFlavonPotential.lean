...
/-!
# UgpLean.MassRelations.CartanFlavonPotential — Claim C sub-(ii)

** (Track D Claim C residual sub-question (ii)):** structural origin of
the transcendental flavon VEVs ε_1 = e^(−π/3), ε_2 = e^(−π/8) introduced in
's Froggatt-Nielsen UV completion of TT.
