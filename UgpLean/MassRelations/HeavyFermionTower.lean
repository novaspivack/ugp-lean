...
/-!
# UgpLean.MassRelations.HeavyFermionTower — Round 24 Claim C Candidate 2

**Round 24 (Track D Claim C alternative UV completion):** non-perturbative
heavy-fermion-tower model whose effective Yukawa flavor structure is
EFT-DUAL to Round 21's two-flavon Froggatt-Nielsen model.
...
gives **identical** predictions to the FN-doubled model from Round 21.
...
/-- **EFT-DUALITY (Round 24):** the heavy-fermion-tower predicts the same
