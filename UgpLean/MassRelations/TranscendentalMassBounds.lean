...
/-- FN flavon ε_FN² = exp(−2π/3) for three-generation washout sum. -/
axiom exp_neg_two_pi_over_three_bounds :
    (1231447 : ℝ) / 10000000 < Real.exp (-(2 * Real.pi / 3)) ∧
    Real.exp (-(2 * Real.pi / 3)) < (1231448 : ℝ) / 10000000

/-- exp(−2π) second term in three-generation FN washout sum. -/
axiom exp_neg_two_pi_bounds :
    (18674 : ℝ) / 10000000 < Real.exp (-2 * Real.pi) ∧
    Real.exp (-2 * Real.pi) < (18675 : ℝ) / 10000000

/-- exp(−π) for Pati–Salam M_R1 BPS factor ε_FN^{N_c}. -/
axiom exp_neg_pi_bounds :
    (43213 : ℝ) / 1000000 < Real.exp (-Real.pi) ∧
    Real.exp (-Real.pi) < (43214 : ℝ) / 1000000

/-- GTE Δm²₂₁ interval from orbit ratios and Σm_ν = 59.4 meV. -/
axiom gte_delta_m21_sq_interval :
    (736 : ℝ) / 10000000 ≤
      (((594 : ℝ) / 10000) /
          ((5 : ℝ) ^ ((29 : ℝ) / 9) + (11 : ℝ) ^ ((29 : ℝ) / 9) + (19 : ℝ) ^ ((29 : ℝ) / 9)) *
        (11 : ℝ) ^ ((29 : ℝ) / 9)) ^ 2 -
        (((594 : ℝ) / 10000) /
          ((5 : ℝ) ^ ((29 : ℝ) / 9) + (11 : ℝ) ^ ((29 : ℝ) / 9) + (19 : ℝ) ^ ((29 : ℝ) / 9)) *
        (5 : ℝ) ^ ((29 : ℝ) / 9)) ^ 2 ∧
...
/-- GTE Δm²₃₁ interval from orbit ratios and Σm_ν = 59.4 meV. -/
axiom gte_delta_m31_sq_interval :
    (2509 : ℝ) / 1000000 ≤
      (((594 : ℝ) / 10000) /
          ((5 : ℝ) ^ ((29 : ℝ) / 9) + (11 : ℝ) ^ ((29 : ℝ) / 9) + (19 : ℝ) ^ ((29 : ℝ) / 9)) *
        (19 : ℝ) ^ ((29 : ℝ) / 9)) ^ 2 -
...
/-- M_R_GUT = E_D²/C interval (GeV), E_D = v_H/29, C = Σm_ν/Σ b^α. -/
axiom mr_gut_geV_interval :
    (189 : ℝ) * 10 ^ 16 ≤
...
/-- M_R1/M_R_GUT = exp(−π)/(19/5)^α interval. -/
axiom mr1_mr_gut_ratio_interval :
    (5828 : ℝ) / 10000000 ≤
      Real.exp (-Real.pi) / ((19 : ℝ) / (5 : ℝ)) ^ ((29 : ℝ) / 9) ∧
    Real.exp (-Real.pi) / ((19 : ℝ) / (5 : ℝ)) ^ ((29 : ℝ) / 9) ≤
      (5863 : ℝ) / 10000000
