...
**377 modules · zero sorry on the core proof path · Lean 4 + Mathlib**
...
377 modules organized in 17 layers. Full module lists are in [docs/MODULES.md](docs/MODULES.md) and the formalization paper.
